            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item  position-relative">
                  ...
                  <p>Je vous accompagne dans la gestion de vos chantiers, gestion de vos équipes, gestion des besoins,
                    métrés, réponse aux appels d'offres, réunion de chantiers,...</p>
                  <p>En fonction de la prestation que vous souhaitez me confiez, nous définirons ensemble la méthode,
                    les délais, les coût,...</p>
              ...
              <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-item position-relative">
                  ...
                  <h3>Renforcement de vos équipes</h3>
              ...
              <script type="application/json" class="swiper-config">
            {
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img src="assets/img/testimonials/couverture tôle.jpg" class="testimonial-img" alt="">
                      <h3>Couverture Tôles</h3>
                      <h4>Couvreur</h4>
                      <div class="stars">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img src="assets/img/testimonials/ardoise.jpg" class="testimonial-img" alt="">
                      <h3>Couverture ardoise</h3>
                      <h4>Store Owner</h4>
                      <div class="stars">
                        <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                ...
                <div class="swiper-slide">
                  <div class="testimonial-wrap">
                    <div class="testimonial-item">
                      <img src="assets/img/testimonials/bardage apparement.jpg" class="testimonial-img" alt="">
                      <h3>Bardage apparement</h3>
                      <h4>Entrepreneur</h4>
                      <div class="stars">
                        <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                          class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-2 col-md-3 footer-links">
              ...
              <ul>
                ...
                <li><a href="#">A propos de mois</a></li>
