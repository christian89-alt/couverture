            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item  position-relative">
                  ...
                  <p>Je vous propose mes services dans le cadre de vos besoins en sous traitance, respectueux des délais je saurais valoriser nos rapports professionnels.J'assiste vos équipes dans la pose de toutes sortes d'éléments de couvertures, tôle,tuiles, ardoises,chêneaux, pose d'eaux pluviales.</p>
              ...
              <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-item position-relative">
                  ...
                  <h3>Renforcement d'équipe</h3>
                  <p>Je vous propose de venir renforcer vos équipes de couvreur en évitant les difficultés d'un recrutement souvent complexe et chronophage, mon offre vous permettra d'optimiser votre besoin de flexibilité entrepreunarial en optimisant vos coûts en ressources humaines.J'assiste vos équipes dans la pose de toutes sortes d'éléments de couvertures, tôle,tuiles, ardoises,chêneaux. </p>
                  <a href="contact.html" class="readmore stretched-link">Devis <i class="bi bi-arrow-right"></i></a>
                </div>
              </div><!-- End Service Item -->
          ...
          <div class="container">
            ...
            <div class="row justify-content-around gy-4">
              ...
              <div class="col-lg-6 d-flex flex-column justify-content-center order-2 order-lg-1" data-aos="fade-up"
                data-aos-delay="100">
                <h3>Comment je suis rémunéré? </h3>
                <p>Je vous propose un ensemble de forfait dont l'objectif est de permettre à votre entreprise de
                  disposer d'une certaine flexibilité en évitant la mise en place d'un recrutement compliqué et
                  incertain. </p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 icon-box d-flex">
                    ...
                    <div>
                      <h4>Forfait à la journée</h4>
                      <p>Je m'intègre à vos équipes par la mise en place d'une convention d'une journée donnant lieu à
                        une facturation à la journée. </p>
                    </div>
                  </div><!-- End Icon Box -->
                  ...
                  <div class="col-lg-6 icon-box d-flex">
                    ...
                    <div>
                      <h4>Forfait à la semaine </h4>
                      <p>Je m'intègre à vos équipes pour une semaine, par le biais d'un forfait à la semaine.</p>
                    </div>
                  </div><!-- End Icon Box -->
                  ...
                  <div class="col-lg-6 icon-box d-flex">
                    ...
                    <div>
                      ...
                      <p>Je m'intègre à vos équipes pour une durée d'un mois, par la mise en place d'une convention bi
                        partite valable un mois renouvelable. </p>
                    </div>
                  </div><!-- End Icon Box -->
                  ...
                  <div class="col-lg-6 icon-box d-flex">
                    <i class="bi bi-brightness-high flex-shrink-0"></i>
                    <div>
                      <h4>Rémunération sur mesure</h4>
                      <p>Vous ne rentrez pas dans ce cadre? Besoin d'une durée plus ajustée? Discutons -en et n'hésitez
              ...
              <div class="features-image col-lg-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="200">
                <img src="assets/img/mes services/construction.jpg" alt="">
              </div>
